...
class BeLocalIconButton extends StatefulWidget {
  const BeLocalIconButton({
    super.key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<BeLocalIconButton> createState() => _BeLocalIconButton();
}

class _BeLocalIconButton extends State<BeLocalIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(BeLocalIconButton oldWidget) {
