...
abstract class BePlantTheme {
  ...
  static BePlantTheme of(BuildContext context) {
...
class LightModeTheme extends BePlantTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primaryBackground = const Color(0xFFF3FCF0);
...
class DarkModeTheme extends BePlantTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
