...
Widget wrapWithModel<T extends BePlantModel>({
  required T model,
...
T createModel<T extends BePlantModel>(
...
abstract class BePlantModel<W extends Widget> {
...
class FlutterFlowDynamicModels<T extends BePlantModel> {
